            ...
            <table className="w-full text-sm table-auto border-collapse text-left">
              <thead className="bg-blue-600 text-white/95">
                <tr>
                  ...
                  <th className="px-6 py-4 font-bold tracking-wide text-xs uppercase opacity-90">Symptoms</th>
                  <th className="px-6 py-4 font-bold tracking-wide text-xs uppercase opacity-90">Urgency</th>
                  ...
                  <tr key={c._id} className="hover:bg-slate-50/70 transition-all duration-150 group">
                    ...
                    <td className="px-6 py-4 text-right">
                      <div className="flex gap-1.5 justify-end items-center">
                        <Link to={`/consultations/${c._id}`} className="inline-flex items-center justify-center bg-slate-100 hover:bg-blue-50 text-blue-600 border border-slate-200 p-2 rounded-xl transition shadow-sm">
