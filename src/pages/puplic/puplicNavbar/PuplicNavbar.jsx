...
const PublicNavbar = ({ isDark, toggleTheme }) => {
      ...
      <div className="max-w-6xl mx-auto px-6 h-16 flex items-center justify-between">
        <Link to="/" className={`text-xl font-bold flex items-center gap-1.5 tracking-tight transition-colors ${
          ...
          <div className="flex items-center gap-1">
            ...
            <svg className="w-5 h-5 text-blue-500" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
              <path d="M4.8 8H12a5 5 0 0 1 5 5v3a3 3 0 0 1-3 3H8a3 3 0 0 1-3-3v-3a5 5 0 0 1 5-5h2.2" />
              <path d="M5 8V4h4" />
              <path d="M19 8V4h-4" />
