...
import { resetPasswordOtpRequest, forgotPasswordRequest } from '../../api/Auth';
...
export default function ResetPassword() {
  ...
  const handleSubmit = async (e) => {
    ...
    // نفس قاعدة قوة الباسورد المطبقة في الباك اند بالظبط
    ...
    setIsLoading(true);
    try {
      await resetPasswordOtpRequest(email.trim().toLowerCase(), otp.trim(), newPassword);
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setServerError(!err.response ? t('auth.networkError') : t('common.somethingWentWrong'));
    }
  };
