...
export const patientSchema = z
  .object({
    name: z
      ...
      .regex(/^[\u0621-\u064A\s]+$/, 'Name must be written in Arabic letters only'),
    nationalID: z
      .string()
      ...
      .refine((val) => {
        ...
        return (governorateCode >= 1 && governorateCode <= 35) || governorateCode === 88;
  ...
  .superRefine((data, ctx) => {
    ...
    if (!nationalID || nationalID.length !== 14 || !/^\d+$/.test(nationalID)) return;
